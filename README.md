...
설치·빌드 불필요 · 순수 HTML/CSS/JS · 라이트/다크 · 5개 언어 · 월간 시즌 랭킹 · 결과 공유 카드
...
<sub>Vanilla JS · 의존성 0 · 단위 38 + E2E 테스트 · 문제 유형 18종 · 5개 로케일 · 웹서치 교차검증 데이터</sub>
...
| 모드 | 설명 |
|---|---|
| 🎲 **일반** | 랜덤 10장 + **난이도 선택**(쉬움 ×0.8 · 보통 ×1.0 · 어려움 ×1.3, 랭킹은 통합·배수로 공정) |
...
🌐 **5개 언어**(한국어·English·日本語·中文·Español, 접속 지역 자동 감지 + 수동 전환)
...
js/
  i18n.js             # UI 문자열 중앙화 · 5개 로케일           ┐ 브라우저 & Node 공용
