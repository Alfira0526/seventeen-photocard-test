...
- 자켓 1장당 **랜덤 유형 1문제**, 4지선다 (한 판 = 10장, 문제당 10점, 만점 100점)
- 문제 유형(그 앨범에 데이터가 있으면 고난도 유형도 출제):
  - 기본: **앨범 / 발매연도 / 타이틀곡**
  - 고난도: **수록곡이 아닌 것 / 타이틀곡 작사 참여 멤버 / 특정 유닛이 부른 곡**
...
js/questions.js       # 문제 유형 레지스트리(가용성+가중 랜덤) — 공용, 테스트 대상
js/data.js            # 정답 소스: ALBUMS(+수록곡/유닛/작사 멤버) + 무결성 검증
