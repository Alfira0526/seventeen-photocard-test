  ...
  const LOCALES = {
    ko: {
      ...
      ui: {
        ...
        annItem1: "⚡ 새 점수 방식 — 빠르고 어려운 문제일수록, 콤보를 이어갈수록 高점수!",
    ...
    en: {
      ...
      ui: {
        ...
        annItem1: "⚡ New scoring — faster & harder answers and longer combos score higher!",
    ...
    ja: {
      ...
      ui: {
        ...
        annItem1: "⚡ 新スコア — 速く・難しい問題・コンボ継続ほど高得点！",
    ...
    zh: {
      ...
      ui: {
        ...
        annItem1: "⚡ 全新计分 — 答得越快、题目越难、连击越长，分越高！",
    ...
    es: {
      ...
      ui: {
        ...
        annItem1: "⚡ Nueva puntuación — responder rápido, preguntas difíciles y combos dan más puntos",
