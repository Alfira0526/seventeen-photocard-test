...
(function (root) {
  ...
  const LOCALES = {
    ko: {
      ...
      ui: {
        tagline: "자켓만 보고 <b>앨범·연도·타이틀곡</b>까지 척척? 진짜 캐럿인지 지금 가려봐요.",
        rule1: "딱 <b>20문제</b>, 한 문제씩 가볍게 풀어요",
        rule2: "쉬움부터 <b>최상</b>까지, 난이도는 미리 귀띔해드려요",
        rule3: "다 풀면 <b>캐럿 등급</b> 등장 · 자랑은 필수예요 😎",
        modeNormalT: "🎲 가볍게 한 판", modeNormalS: "랜덤 20문제 · 100점부터 시작",
    ...
    en: {
      ...
      ui: {
        tagline: "Just the cover — name the <b>album, year & title track</b>? Time to prove you're a real CARAT.",
        rule1: "Just <b>20 questions</b>, one easy tap at a time",
        rule2: "Every question shows its <b>difficulty (Easy–Expert)</b> up front",
        rule3: "Finish and unlock your <b>CARAT tier</b> · bragging encouraged 😎",
        modeNormalT: "🎲 Quick Round", modeNormalS: "20 random · start at 100",
    ...
    ja: {
      ...
      ui: {
        tagline: "ジャケットだけで<b>アルバム・年・タイトル曲</b>まで当てられる？ 本物のCARATか今チェック。",
        rule1: "全<b>20問</b>、1問ずつサクッと",
        rule2: "やさしい〜<b>最上級</b>まで、難易度は先にお知らせ",
        rule3: "解き切ると<b>CARAT等級</b>が登場 · 自慢は必須 😎",
        modeNormalT: "🎲 サクッと一戦", modeNormalS: "ランダム20問 · 100点スタート",
    ...
    zh: {
      ...
      ui: {
        tagline: "只看封面就能说出<b>专辑·年份·主打歌</b>？ 是不是真CARAT，现在见分晓。",
        rule1: "共<b>20题</b>，一题一题轻松答",
        rule2: "从简单到<b>顶级</b>，难度提前告诉你",
        rule3: "答完就有<b>CARAT 等级</b> · 尽管炫耀 😎",
        modeNormalT: "🎲 轻松一局", modeNormalS: "随机20题 · 从100分开始",
    ...
    es: {
      ...
      ui: {
        tagline: "Solo la portada — ¿aciertas <b>álbum, año y canción principal</b>? Demuestra que eres un CARAT de verdad.",
        rule1: "Solo <b>20 preguntas</b>, una a una y sin prisa",
        rule2: "Cada pregunta muestra su <b>dificultad (Fácil–Experto)</b> por adelantado",
        rule3: "Termina y desbloquea tu <b>nivel CARAT</b> · presumir es obligatorio 😎",
        modeNormalT: "🎲 Partida rápida", modeNormalS: "20 al azar · empiezas con 100",
